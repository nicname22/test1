...
def detect(wav_file):
    ...
    for frequencyIndex in range(0, len(fftFrequenciesOneSide)):
        if 110 <= fftFrequenciesOneSide[frequencyIndex] <= 8200:  # Range of musical note frequencies
            ...
            if normalizedAbsoluteValues[frequencyIndex] > 0.025:  # Lower threshold to capture more frequencies
    ...
    # Print the detected notes in the terminal
    if recordedNotes:
        print("Detected notes:", ", ".join(recordedNotes))
    else:
