...
def detect():
    ...
    timeVector = numpy.arange(0, seconds, timeSamplesPerSecond)
    ...
    for frequencyIndex in range(0, len(fftFrequenciesOneSide)):
        if 110 <= fftFrequenciesOneSide[frequencyIndex] <= 8200:  # Range of musical note frequencies
            ...
            # Print the frequency and its normalized value for debugging
            # print(f"Frequency: {fftFrequenciesOneSide[frequencyIndex]:.2f} Hz, Normalized Value: {normalizedAbsoluteValues[frequencyIndex]:.4f}")
